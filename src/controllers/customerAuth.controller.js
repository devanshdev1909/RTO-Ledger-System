...
exports.postRegister = async (req, res) => {
  ...
  if (!name || !mobile || !password) {
    return res.render("customers/portal/register", {
  ...
  try {
    ...
    res.render("customers/portal/register", {
...
exports.postActivateAccount = async (req, res) => {
  ...
  if (!mobile || !password) {
    return res.render("customers/portal/activate", {
      error: "Please fill in all required fields.",
    });
  }
  ...
  try {
    ...
    console.error(err);
    res.render("customers/portal/activate", {
...
exports.postLogin = async (req, res) => {
  ...
  try {
    ...
    if (!customer.password) {
      return res.render("auth/login", {
        activeTab: "customer",
        error: "Please contact admin to set a password.",
      });
    }
