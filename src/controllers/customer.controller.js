...
const deleteCustomer = async (req, res) => {
    try {
        ...
        if (err.code === '23503' || (err.message && err.message.includes('violates foreign key constraint'))) {
            return res.redirect('/customers?error=' + encodeURIComponent("Cannot delete this customer because they are currently linked to existing vehicles, service requests, or ledgers. Please remove those connections first."));
        }
